...
#' - Rattus norvegicus
#' 
#' All transcriptomes use the primary genome build for Ensembl release 91
#' 
...
setwd(here::here("Release91"))

spList <- list(
  Bs = c(sp = "Bos_taurus", bld = "UMD3.1", rls = "91"),
  Dr = c(sp = "Danio_rerio", bld = "GRCz10", rls = "91"),
  Gg = c(sp = "Gallus_gallus", bld = "Gallus_gallus-5.0", rls = "91"),
  Hs = c(sp = "Homo_sapiens", bld = "GRCh38", rls = "91"),
  Mm = c(sp = "Mus_musculus", bld = "GRCm38", rls = "91"),
  Rn = c(sp = "Rattus_norvegicus", bld = "Rnor_6.0", rls = "91")
)
