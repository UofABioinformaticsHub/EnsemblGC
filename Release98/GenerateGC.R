...
#' - Rattus norvegicus
#' 
#' All transcriptomes use the primary genome build for Ensembl release 98
#' 
...
setwd(here::here("Release98"))

spList <- list(
  Bs = c(sp = "Bos_taurus", bld = "ARS-UCD1.2", rls = "98"),
  Dr = c(sp = "Danio_rerio", bld = "GRCz11", rls = "98"),
  Gg = c(sp = "Gallus_gallus", bld = "GRCg6a", rls = "98"),
  Hs = c(sp = "Homo_sapiens", bld = "GRCh38", rls = "98"),
  Mm = c(sp = "Mus_musculus", bld = "GRCm38", rls = "98"),
  Rn = c(sp = "Rattus_norvegicus", bld = "Rnor_6.0", rls = "98")
)
