...
#' - Rattus norvegicus
#' 
#' All transcriptomes use the primary genome build for Ensembl release 97
#' 
...
setwd(here::here("Release97"))

spList <- list(
  Bs = c(sp = "Bos_taurus", bld = "ARS-UCD1.2", rls = "97"),
  Dr = c(sp = "Danio_rerio", bld = "GRCz11", rls = "97"),
  Gg = c(sp = "Gallus_gallus", bld = "GRCg6a", rls = "97"),
  Hs = c(sp = "Homo_sapiens", bld = "GRCh38", rls = "97"),
  Mm = c(sp = "Mus_musculus", bld = "GRCm38", rls = "97"),
  Rn = c(sp = "Rattus_norvegicus", bld = "Rnor_6.0", rls = "97")
)
