...
#' - Rattus norvegicus
#' 
#' All transcriptomes use the primary genome build for Ensembl release 93
#' 
...
setwd(here::here("Release93"))

spList <- list(
  Bs = c(sp = "Bos_taurus", bld = "UMD3.1", rls = "93"),
  Dr = c(sp = "Danio_rerio", bld = "GRCz11", rls = "93"),
  Gg = c(sp = "Gallus_gallus", bld = "Gallus_gallus-5.0", rls = "93"),
  Hs = c(sp = "Homo_sapiens", bld = "GRCh38", rls = "93"),
  Mm = c(sp = "Mus_musculus", bld = "GRCm38", rls = "93"),
  Rn = c(sp = "Rattus_norvegicus", bld = "Rnor_6.0", rls = "93")
)
