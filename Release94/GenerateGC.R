...
#' - Rattus norvegicus
#' 
#' All transcriptomes use the primary genome build for Ensembl release 94
#' 
...
setwd(here::here("Release94"))

spList <- list(
  Bs = c(sp = "Bos_taurus", bld = "UMD3.1", rls = "94"),
  Dr = c(sp = "Danio_rerio", bld = "GRCz11", rls = "94"),
  Gg = c(sp = "Gallus_gallus", bld = "Gallus_gallus-5.0", rls = "94"),
  Hs = c(sp = "Homo_sapiens", bld = "GRCh38", rls = "94"),
  Mm = c(sp = "Mus_musculus", bld = "GRCm38", rls = "94"),
  Rn = c(sp = "Rattus_norvegicus", bld = "Rnor_6.0", rls = "94")
)
