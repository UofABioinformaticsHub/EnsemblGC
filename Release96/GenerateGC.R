...
#' - Rattus norvegicus
#' 
#' All transcriptomes use the primary genome build for Ensembl release 96
#' 
...
setwd(here::here("Release96"))

spList <- list(
  Bs = c(sp = "Bos_taurus", bld = "ARS-UCD1.2", rls = "96"),
  Dr = c(sp = "Danio_rerio", bld = "GRCz11", rls = "96"),
  Gg = c(sp = "Gallus_gallus", bld = "GRCg6a", rls = "96"),
  Hs = c(sp = "Homo_sapiens", bld = "GRCh38", rls = "96"),
  Mm = c(sp = "Mus_musculus", bld = "GRCm38", rls = "96"),
  Rn = c(sp = "Rattus_norvegicus", bld = "Rnor_6.0", rls = "96")
)
