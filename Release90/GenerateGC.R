...
#' - Rattus norvegicus
#' 
#' All transcriptomes use the primary genome build for Ensembl release 90
#' 
...
setwd(here::here("Release90"))

spList <- list(
  Bs = c(sp = "Bos_taurus", bld = "UMD3.1", rls = "90"),
  Dr = c(sp = "Danio_rerio", bld = "GRCz10", rls = "90"),
  Gg = c(sp = "Gallus_gallus", bld = "Gallus_gallus-5.0", rls = "90"),
  Hs = c(sp = "Homo_sapiens", bld = "GRCh38", rls = "90"),
  Mm = c(sp = "Mus_musculus", bld = "GRCm38", rls = "90"),
  Rn = c(sp = "Rattus_norvegicus", bld = "Rnor_6.0", rls = "90")
)
